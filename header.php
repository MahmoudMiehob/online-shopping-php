		...
		<div id="top-header">
			...
			<ul class="header-links pull-left">
				...
				if (isset($_SESSION["uid"])) {
					$sql = "SELECT first_name ,email,address1,mobile FROM user_info WHERE user_id='$_SESSION[uid]'";
					...
					<li><a href="#"><i class="fa fa-map-marker"></i><?= $row["address1"] ?></a></li>
					<?php
					} else {
					echo '<li>No user found with the given ID.</li>';
					}?>
				</ul>
				...
				if (isset($row["first_name"])) {
					echo '
						<div class="dropdownn">
						<a href="#" class="dropdownn" data-toggle="" data-target="" ><i class="fa fa-user-o"></i> HI ' . $row["first_name"] . '</a>
				...
				echo '
				<div class="dropdownn">
					<a href="#" class="dropdownn" data-toggle="" data-target="" ><i class="fa fa-user-o"></i> My Account</a>
					<div class="dropdownn-content">
