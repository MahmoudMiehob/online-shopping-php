                        ...
                        <div class='col-md-4 col-xs-6' >
								<a href='product.php?p=$pro_id'><div class='product'>
									...
									<div class='product-body'>
										...
										<button pid='<?= $pro_id ?>' id='wishlist' class='add-to-wishlist'><i class='fa fa-heart-o'></i></button>
									<?php echo "	
									</div>
									</div>";?>
									<div class='add-to-cart'>
										<button pid='<?= $pro_id?> ' id='productaddtocart' class='add-to-cart-btn block2-btn-towishlist'
...
if(isset($_POST["get_seleted_Category"]) || isset($_POST["selectBrand"]) || isset($_POST["search"])){
	...
	if(isset($_POST["addToWishlist"])){
		...
		if($count > 0){
			echo "<script>
			setTimeout(function(){
				alert('Product is already added into the wishlist. Continue Shopping..!');
				...
				while ($row=mysqli_fetch_array($query)) {
					...
					echo 
						...
						<tr>
							...
							<td class="" data-th="">'?>
							<a href="#" id="product12" pid="<?php echo $product_id; ?>" class="btn btn-success">Move to Cart</a>
							...
							<script>
								document.getElementById("product12").addEventListener("click", function() {
									document.getElementById("addToCartForm").submit();
								});
							</script>
							<?php echo '
